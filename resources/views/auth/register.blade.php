...
@section('content')
   <div class="hidden-xs">
				...
				<form action="{{ route('register') }}"
					...
					<fieldset>
						...
						<input type="file"
						       ...
						       id="image"
						       aria-describedby="image" name="photo">
						<small id="fileHelp"
	...
	<option value="ZWE">Zimbabwe</option>
						...
						<label class="col-form-label required">City</label> <input class="form-control"
						       type="text" name="city"> <label class="col-form-label required">Postal-Code</label></label> <input class="form-control"
						       type="text"
						       pattern="[0-9]{5}" name="postalCode">
						<label class="col-form-label required">Address</label> <input class="form-control"
